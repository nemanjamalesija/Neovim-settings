return {
  ...
  --           ["@boolean"] = { fg = colors.palette.sublimePink, bold = false },
  --           ["@number"] = { fg = colors.palette.sublimePink, bold = false },
  ...
  --           ["@operator"] = { fg = colors.palette.lotusRed },
    ...
    config = function()
      require("catppuccin").setup({
        ...
        custom_highlights = function(colors)
          return {
            -- ["@function"] = { fg = "#66ad66" }, -- Correct field name
            -- ["@function.method.call"] = { fg = "#66ad66" },
          }
        end,
      })
